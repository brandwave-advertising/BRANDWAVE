                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        decoration: const InputDecoration(
                          border: OutlineInputBorder(
                              borderSide: BorderSide(
                                  width: 3,
                                  color: Color.fromRGBO(33, 149, 243, 0.551))),
                          labelText: "Name",
                      ...
                      TextFormField(
                        ...
                        minLines: 6,
                        onChanged: (text) => {
                          setState(() => {advertDescription = text})
                        },
                      ),
                      const SizedBox(
                        height: 10.0,
                      ...
                      !filesSelected
                          ...
                          : Row(
                              ...
                              children: files!
                                  .map((path) => Image.file(
                                      width: 150.0, height: 100.0, path))
                                  .toList()),
                      Row(
                          mainAxisAlignment: MainAxisAlignment.start,
                          children: files!
                              .map((path) =>
                                  Image.file(width: 150.0, height: 100.0, path))
                              .toList()),
                    ],
                  ),
                ),
